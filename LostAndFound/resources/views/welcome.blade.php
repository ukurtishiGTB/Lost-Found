...
<body class="antialiased">
    <div class="relative min-h-screen bg-gradient-to-br from-indigo-100 to-white dark:from-gray-900 dark:to-gray-800">
        <div class="absolute top-0 right-0 p-6">
            <div class="space-x-4">
                <a href="{{ route('dashboard') }}" class="px-4 py-2 font-medium text-indigo-600 border border-indigo-600 rounded-lg hover:bg-indigo-50 dark:hover:bg-gray-800 transition-colors">Dashboard</a>
                <a href="{{ route('login') }}" class="px-4 py-2 font-medium text-white bg-indigo-600 rounded-lg hover:bg-indigo-500 transition-colors">Admin Login</a>
            </div>
        </div>
